package com.igorgomes.workshopmongo.config;
...
import com.igorgomes.workshopmongo.dto.AuthorDTO;
import com.igorgomes.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Aproveite", sdf.parse("19/03/2018"), new AuthorDTO(bob));
